    ...
    const incidentDates = geoJson.features
      .filter(
        (feature) =>
          ...
          feature.properties.nom_com === comuna
      )
      ...
      <Card>
        <CardHeader className="flex flex-row justify-between">
          <div>
            ...
            <CardDescription>
              Registro y datos relacionados con el incidente
            </CardDescription>
          </div>
          <div className="flex sm:flex-row flex-col justify-end space-x-4 space-y-1">
            <Button variant="outline">
              <Upload className="mr-2 h-4 w-4" />
              <span className="hidden sm:block">Importar Información</span>
            </Button>
            <Button variant="destructive">
              <AlertTriangle className="mr-2 h-4 w-4" />
              <span className="hidden sm:block">Finalizar Incidente</span>
            </Button>
            <Button className="bg-blue-600 text-white hover:bg-blue-700">
              <Bell className="mr-2 h-4 w-4" />
              <span className="hidden sm:block">Alerta</span>
            </Button>
          </div>
        </CardHeader>
              ...
              {/* <div className="flex flex-wrap gap-5 justify-center items-center">
                <div className="space-y-2 w-1/4">
                  {InfrastructureData.map((item) => (
                    <Card key={item.id} className="flex items-center p-4 ">
                      <div
                        className={`text-2xl ${item.color} rounded-full p-2`}
                      >
                        {item.icon}
                      </div>
                      <div>
                ...
                <div className="w-1/2 items-center justify-center ">
                  <img
                    ...
                    className="w-66 h-96 object-contain rounded-lg"
                  />
                </div>
              </div> */}
              <Charts />
