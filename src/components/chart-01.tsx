  ...
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      <div className="flex gap-20">
        <Card className="lg:max-w-md w-96" x-chunk="charts-01-chunk-0">
          <CardHeader className="p-4 pb-0">
            <CardTitle>Infraestructura Afectada</CardTitle>
            <CardDescription>Resumen de la infraestructura</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex-col items-start gap-1">
            <CardDescription>
              ...
              <span className="font-medium text-foreground">17/10/2024</span>
            </CardDescription>
          </CardFooter>
        </Card>
        <Card
          className="flex flex-col lg:max-w-md w-96"
          x-chunk="charts-01-chunk-1"
        >
          <CardHeader className="">
            <CardTitle>Tendencia del Incidente</CardTitle>
            <CardDescription>Evolución del incidente en ha </CardDescription>
          </CardHeader>
