            ...
            try {
                ...
                if (data && data.features && data.features.length > 0) {
                    ...
                    if (initialIncidentId) {
                        handleIncidenteChange({ target: { value: initialIncidentId } }, true); // Pasar flag para seleccionar la fecha más reciente
                    }
                } else {
    ...
    const handleProvinciaChange = (event) => {
        ...
        if (provincia === 'Todo el desastre') {
            ...
            const filteredData = {
                ...
                features: geojsonDataRef.current.features.filter((feature) => feature.properties.nom_pro === provincia),
            };
